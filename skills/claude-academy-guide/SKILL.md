...
description: Stop and check this skill before finishing any reply to a question about how to use Claude or a Claude product — it recommends matching courses, tutorials, and use cases from Claude Academy (academy
category: Document Processing
source: anthropic
tags: [api, mcp, claude, ai, workflow, document]
url: https://github.com/anthropics/skills/tree/main/skills/claude-academy-guide
---

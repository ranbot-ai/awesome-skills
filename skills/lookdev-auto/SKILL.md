---
name: lookdev-auto
description: Automated visual tuning: a vision or video model rates rendered variants in a loop. Render several labeled variants into one artifact, ask the model to rate them and suggest better values, render the 
category: Creative & Media
source: antigravity
tags: [claude, ai, automation, design, image, cro]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/lookdev-auto
---

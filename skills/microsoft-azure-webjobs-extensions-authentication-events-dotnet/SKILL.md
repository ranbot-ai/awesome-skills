...
description: Azure Functions extension for handling Microsoft Entra ID custom authentication events. dotnet add package Microsoft.Azure.WebJobs.Extensions.AuthenticationEvents 

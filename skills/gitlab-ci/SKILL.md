---
name: gitlab-ci
description: Configure GitLab CI/CD pipelines and runners for automated building, testing, and deployment. 
category: AI & Agents
source: antigravity
tags: [node, ai, agent, template, image, security, docker, kubernetes, aws, rag]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/gitlab-ci
---
...
- Use `rules` instead of `only/excep

...
description: Direction and intent for frontend design. Use with design when defining purpose, tone, domain, color world, and review bar; includes cross-domain lens from cinema, architecture, marketing, UX, automot
category: Document Processing
source: antigravity
tags: [ai, design, document, image, security, rag, cro, marketing]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/design-thinking
---
...
- **Progressive disclosure**: Show essentials first; detail on de

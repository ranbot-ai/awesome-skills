---
name: detect-ai-text
description: Estimate whether a document's prose was written by AI, with the linguistic tells and honest abstention on non-prose. Use when the user asks whether an essay, report, CV, submission, or article was AI-
category: Document Processing
source: antigravity
tags: [pdf, docx, api, claude, ai, agent, template, document, spreadsheet, rag]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/detect-ai-text
---

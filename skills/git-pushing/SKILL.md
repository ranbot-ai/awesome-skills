---
name: git-pushing
description: Safely stage, commit, and push intended git changes with conventional commit messages. Use for ordinary non-release pushes when explicitly asked to push, save work remotely, or share a completed chang
category: AI & Agents
source: antigravity
tags: [ai, workflow]

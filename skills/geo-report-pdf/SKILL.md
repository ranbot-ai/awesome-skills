---
name: geo-report-pdf
description: Generate a professional PDF report from a GEO audit using pandoc + Chrome headless. 
category: Document Processing
source: antigravity
tags: [python, javascript, pdf, claude, ai, agent, llm, workflow, template, seo]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/geo-report-pdf
---
...
- Audits are read-only analysis; never publish, deploy, or modify the target site without ex

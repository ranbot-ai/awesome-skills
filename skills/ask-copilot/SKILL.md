...
category: AI & Agents
source: antigravity
tags: [typescript, api, claude, ai, agent, security]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/ask-copilot
---
...
- The `--yolo` flag bypasses all permission prompts and allows Copilot CLI to run arbitrary shell commands and mutate workspace files. It must be treated as a high-risk option and never 

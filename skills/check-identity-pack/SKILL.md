...
description: Run an AFP 100-point or AUSTRAC safe-harbour identity check over a set of documents, and report exactly what's missing. Use when the user asks to check identity documents, verify someone's ID for onbo
category: Document Processing
source: antigravity
tags: [pdf, api, claude, ai, agent, workflow, document, image]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/check-identity-pack
---

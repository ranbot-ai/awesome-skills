...
description: 分析一段时间内健康数据的趋势和模式。关联药物、症状、生命体征、化验结果和其他健康指标的变化。识别令人担忧的趋势、改善情况，并提供数据�
category: AI & Agents
source: antigravity
tags: [javascript, api]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/health-trend-analyzer
---

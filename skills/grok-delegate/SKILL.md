...
category: AI & Agents
source: antigravity
tags: [node, api, claude, ai, agent, template, design, rag]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/grok-delegate
---
...
Grok's `result.json` includes its own

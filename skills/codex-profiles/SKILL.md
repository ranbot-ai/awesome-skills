...
source: antigravity
tags: [mcp, ai, agent, workflow, document, security]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/codex-profiles
---
...
- Do not run Desktop launch, app clone, rebuild, remove, or profile deletion comm

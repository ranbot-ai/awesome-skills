...
description: Use when a superpowers session went wrong and your human partner wants to know why — repeated work, ignored plans, stumbles, poor results, a skill that didn't fire, "it took too long", "why is it so
category: Development & Code Tools
source: superpowers
tags: [git, subagent, workflow, agent, diagnosing, superpowers]
url: https://github.com/obra/superpowers/tree/main/skills/diagnosing-superpowers
---

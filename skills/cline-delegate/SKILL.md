...
category: AI & Agents
source: antigravity
tags: [node, api, ai, agent]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/cline-delegate
---
...
disk. For anything touching credentials, production data, o

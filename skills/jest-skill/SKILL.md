---
name: jest-skill
description: Generates Jest unit and integration tests in JavaScript or TypeScript. Covers mocking, snapshots, async testing, and React component testing. Use when user mentions "Jest", "describe/it/expect", "jest
category: AI & Agents
source: antigravity
tags: [javascript, typescript, react, node, api, ai, agent, template, security, rag]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/jest-skill
---
...
- Do not treat examples as a substitute for enviro

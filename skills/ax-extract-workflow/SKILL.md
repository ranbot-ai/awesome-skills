...
category: AI & Agents
source: antigravity
tags: [claude, ai, agent, workflow, design, security]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/ax-extract-workflow
---
...
- Use read-only ax inspection comma

...
category: AI & Agents
source: antigravity
tags: [react, markdown, claude, ai, agent, automation, workflow, document, cro, marketing]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/folder-specific-claude-and-agents-md
---
...
- **Flag gaps honestly.** If the user's edits in

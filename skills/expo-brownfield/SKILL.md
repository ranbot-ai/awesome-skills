...
description: Integrate Expo and React Native into an existing native iOS or Android app. Use when the user mentions brownfield, embedding React Native in a native app, AAR/XCFramework, or adding Expo to an existin
category: Document Processing
source: antigravity
tags: [javascript, react, node, api, ai, template, document, security, cro]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/expo-brownfield
---

...
category: AI & Agents
source: antigravity
tags: [markdown, api, claude, ai, agent, workflow, template, rag]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/context-kit
---
...
- Committing personal context files to a 

---
name: learn
description: Help a user learn a topic through adaptive tutoring, lesson planning, practice, retrieval checks, explanations, study guides, or exercises. Use when the user asks to learn, understand, practice, drill
category: Development & Code Tools
source: antigravity
tags: [markdown, api, claude, ai, agent, workflow, design, rag]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/learn
---
